...
if [[ ${PV} == 9999 ]]; then
	...
	SRC_URI="
	https://crates.io/api/v1/crates/syn/2.0.15/download
	https://crates.io/api/v1/crates/proc-macro2/1.0.56/download
	https://crates.io/api/v1/crates/quote/1.0.25/download
	"
	inherit git-r3
else
	SRC_URI="https://archive.mesa3d.org/${MY_P}.tar.xz"
	KEYWORDS="~alpha ~amd64 ~arm ~arm64 ~hppa ~ia64 ~loong ~mips ~ppc ~ppc64 ~riscv ~s390 ~sparc ~x86 ~amd64-linux ~x86-linux ~x64-solaris +rusticl"
fi
