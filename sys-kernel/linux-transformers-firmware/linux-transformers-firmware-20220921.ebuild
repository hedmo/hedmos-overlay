...
MY_COMMIT=8fcb3d4a04e6c64da79828e57d1e21f54eb6dd1a
...
src_prepare() {
	...
	local free_software=(
		...
		# brcmfmac (GPL-2+)
		brcm/brcmfmac4329-sdio.asus,tf300t.txt
		brcm/brcmfmac4330-sdio.asus,tf600t.txt
		brcm/brcmfmac4330-sdio.asus,tf700t.txt
		brcm/brcmfmac43241b0-sdio.asus,p1801-t.txt
