...
if [[ ${PV} = *9999 ]]; then
	...
	PV="2c744264d64cc1d0d02167a6e7ebd4d97dd0bdde"
	SRC_URI="https://github.com/FreeCAD/FreeCAD/archive/${PV}.zip -> ${P}.zip
		doc? ( https://github.com/FreeCAD/FreeCAD/releases/download/0.18.1/FreeCAD.0_18.Quick.Reference.Guide.7z -> ${P}.Quick.Reference.Guide.7z )"
	KEYWORDS="~amd64"
...
PATCHES=(
	"${FILESDIR}/freecad-9999-0001-Gentoo-specific-disable-building-assembly-workbench.patch"
	"${FILESDIR}/freecad-9999-0002-Patch-search-for-coin.patch"
